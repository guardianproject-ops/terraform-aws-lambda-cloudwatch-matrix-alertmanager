...
| matrix\_alertmanager\_receiver | The alertmanager receiver to receive the alert | `string` | n/a | yes |
| matrix\_alertmanager\_url | Full URL to the alertmanager matrix endpoint (including query param with shared secret) | `string` | n/a | yes |
